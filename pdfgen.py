...
def About():
  ...
  pdf.setFont("Courier-Bold",20)
  pdf.drawString(40,700,"SANDEEP MEHTA")
  pdf.setFont("Courier-Bold",15)
  pdf.drawString(40,650,"Student, ")
  pdf.drawString(40,630,"Computer Science & Engineering,")
  pdf.drawString(40,610,"Bansal college of Engineering Mandideep,")
  pdf.drawString(40,590,"BHOPAL MP, 462023.")
  pdf.drawString(40,550,"Contact: mehtasandeepkumar0@gmail.com")
  pdf.save()
